...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add Data
        LinkedHashMap<String, String> deviceDataMap = new LinkedHashMap<>();
        ...
        deviceDataMap.put("Battery Percentage", easyBatteryMod.getBatteryPercentage() + "%");
        ...
        deviceDataMap.put("Battery temperature", easyBatteryMod.getBatteryTemperature() + " deg C");
        deviceDataMap.put("Battery voltage", easyBatteryMod.getBatteryVoltage() + " mV");
